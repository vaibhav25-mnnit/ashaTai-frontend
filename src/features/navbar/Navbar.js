...
export default function Navbar({ dontShowNav, title, children }) {
    ...
    const user = {
        ...
        imageUrl: "https://img.freepik.com/free-vector/mysterious-mafia-man-smoking-cigarette_52683-34828.jpg?w=740&t=st=1687517843~exp=1687518443~hmac=b69b7d49c6a50eb27b8c1d30ae235136abf29af5734f5c34702e36addbbe0bdf",
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            setScrollDirection(
                prevScrollPos > currentScrollPos ? 'up' : 'down'
            );
    ...
    return (
        <>
            ...
            {!dontShowNav && 
                <>
                    <nav className={`dark:bg-black dark:text-white bg-gray-800 fixed w-full top-0 z-40 ${(scrollDirection === 'up') ? 'opacity-100' : "opacity-0"}  `}>
                        <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                            <div className="relative flex h-16 items-center justify-between">
                                ...
                                <div className="absolute inset-y-0 right-0 flex items-center pr-2  ml-0 sm:static sm:inset-auto  sm:pr-0 sm:mr-16">
                                    ...
                                    <p className='text-white ml-5 hidden lg:block'>Hello, {user.name}</p>
                        ...
                        " >
                            <input type="checkbox" checked={theme === "dark" ? false : true} onChange={handleThemeSwitch} />
