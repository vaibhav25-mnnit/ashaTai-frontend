...
import { sortProducts, getFilteredProducts, getProducts, getBrands, getCategories } from '../productSlice'
...
export default function Products() {
    ...
    const filters = [
        ...
        },
        {
            id: 'brand',
            name: 'brand',
            options: useSelector((state) => state.products.brands)
        },
    ]
    ...
    const handleFilterChange = (e, section, option) => {
        ...
        /* 
        -->new filter with only object , will try to implement later

        const tempFilter = { ...filterObj };
        if (e.target.checked) {
            if (tempFilter[section.id]) {
                tempFilter[section.id].push(option.value);
            } else {
        ...
        <div className="bg-white">
            <div>
                ...
                <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    {/* Pagination */}
                    <Pagination totalItems={totalProducts} handlePagination={handlePagination} page={page} setPage={setPage} />
                </main>
            </div>
        </div>
    )
...
function Pagination({ totalItems, handlePagination, page, setPage }) {
            ...
            <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
                <div className="flex flex-1 justify-between sm:hidden">
                    ...
                    <div
                        ...
                        className={`cursor-pointer relative inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50  ${page === 1 && 'invisible'} `}
                    >
                        Previous
                    </div>
                    ...
                    <div
                        ...
                        className={`cursor-pointer relative ml-3 inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50  ${page === total_pages && 'invisible'}`}
                    >
                        Next
                    </div>
                ...
                <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                    <div>
                        <p className="text-sm text-gray-700 ">
                            Showing <span className="font-medium">{(page - 1) * ITEMS_PER_PAGE + 1}</span> to <span className="font-medium">{Math.min(totalItems, page * ITEMS_PER_PAGE)}</span> of{' '}
                            ...
                            }
                            {
                                ...
                                >
                                    ...
                                    <ChevronRightIcon onClick={() => {
                                        ...
                                        className="cursor-pointer h-5 w-5" aria-hidden="true" />
                                </div>
                            }
                        </nav>
                    </div>
