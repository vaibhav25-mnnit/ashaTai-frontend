      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl  sm:px-6 lg:pl-8 lg:pr-0">
          ...
          <section
            ...
            className=" flex justify-start lg:justify-between gap-x-5 "
            style={
              {
          ...
          >
            ...
            <div className="w-1/4 hidden lg:block ">
              <div className="lg:col-span-1  px-5 py-2 bg-white shadow">
            ...
            {/* Product grid */}
            <div
              className="w-full h-[550px] py-3  overflow-x-hidden overflow-y-scroll "
              style={
                {
                ...
                {orders.map((order) => (
                  <>
                    <Link to={`/order-details/${order.id}`}>
                      <li
                        key={order.id}
                        className="flex justify-between items-center mb-2 p-3 bg-white shadow border border-[#dbdbdb] hover:shadow-lg hover:pointer-cursor "
                      >
