          ...
          <div className="text-center">
            <div className="flex justify-center">
              <img
                ...
                src={
                  status === "success"
                    ? "https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExN3EyejhiNHIxdjl2cGg2dzlxaXhya3Z3Y3Zhd2t5bmpqdjVmM244bCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/NZyXJ00YoHWA0g3x4x/giphy.gif"
            ...
            <p className="mt-6 text-base leading-7 text-gray-600">
              {" "}
              {status === "success" ? `Order id #${id}` : "Transaction failed"}
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              {status === "success" ? (
                <Link
                  to="/profile?tar=order"
