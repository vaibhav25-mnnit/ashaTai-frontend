    ...
    return (
        <>
            ...
            <div className='dark:bg-black bg-amber-50 grid lg:grid-cols-2 grid-cols-1 min-h-screen lg:px-24 lg:py-48 px-4 py-24' >
                {/*  */}
                <div data-aos='fade-right' data-aos-duration="1000" className='lg:max-w-2xl w-auto lg:pt-20  lg:ml-10'>

                    <div className="lg:text-start text-center ">
                        <h1 className="text-4xl dark:text-white font-bold tracking-tight text-gray-900 sm:text-6xl">Delight Your Palate with Homemade Authenticity.</h1>
                ...
                <div data-aos='fade-left' data-aos-duration="1000" className='max-w-2xl flex md:items-center justify-center '>
                    <ImageChanger />
                </div>
            </div>
        </>
